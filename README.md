...
파일 값으로 갱신), 일치하는 곡이 없으면 새 항목으로 추가합니다. 찬송가는 둘러보기의 **찬송가**
탭에만 보이고 코드·주제·템포 탭에서는 빠집니다.
...
- **둘러보기** — 코드 / 주제 / 템포 / 찬송가 축을 한 화면에서 전환, 가나다·최근 사용순 정렬
  (찬송가는 별도 탭으로 분리되어 코드·주제·템포 탭에는 나오지 않습니다)
